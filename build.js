...
function nav(){return '<div class="nav"><div class="brand">📖 Al-Qur\'an Digital</div><div class="sub">Cloudflare Pages • 114 Surah • Terjemahan Indonesia</div></div>'}
...
fs.writeFileSync(path.join(out, 'manifest.json'), JSON.stringify({ name: "Al-Qur'an Digital", short_name: 'AlQuran', start_url: '/', display: 'standalone', theme_color: '#16a34a', background_color: '#f3f4f6', icons: [] }, null, 2));
console.log('Build selesai: dist/ siap deploy ke Cloudflare Pages');
